...
<body>
    ...
    <div class="banner">
      <div class="banner-wrapper">
        <h4 class="form-signin"> FORM SIGN IN</h4>
        <div class="season-name">
          <span>Email</span><input name="name" type="text" class="input"  style="border: 2px solid #e8d8c5;"/>
        </div>
        <div class="season-name">
          <span>User Name</span><input name="username" type="text" class="input" style="border: 2px solid #e8d8c5;" />
        </div>
        <div class="season-name">
          <span>Phone</span><input name="Phone" type="text" class="input"  style="border: 2px solid #e8d8c5;"/>
        </div>
        <div class="season-name">
          <span>Password</span><input name="password" type="text" class="input"  style="border: 2px solid #e8d8c5;"/>
        </div>
        <div class="season-name">
          <span>Re-password</span><input name="re-password" type="text" class="input"  style="border: 2px solid #e8d8c5;"/>
        </div>
